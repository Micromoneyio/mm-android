...
import mm.com.mmafrica.fcm.MessagingService;
import mm.com.mmafrica.location.LocationManager;
import mm.com.mmafrica.location.LocationService;
import mm.com.mmafrica.network.ApiManager;
import mm.com.mmafrica.network.ConnectionBroadcastReceiver;
import mm.com.mmafrica.network.OnConnectionListener;
import mm.com.mmafrica.Ln;
...
public class MainActivity extends AppCompatActivity implements OnConnectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress.loadUrl("file:///android_asset/loading_africa.html");
        ...
        mLocationManager.getSubject()
                ...
                .subscribe(new Observer<Location>() {
                    ...
                    public void onError(Throwable e) {
                        mHandler.post(() -> mWebView.loadUrl(Settings.BASE_URL));
                        loadingPage = "file:///android_asset/loading_africa.html";
                        mHandler.post(() -> mProgress.loadUrl(loadingPage));
                    }
                            ...
                            return gc.getFromLocation(location.getLatitude(), location.getLongitude(), 1);
                                ...
                                .subscribe(new Observer<List<Address>>() {
                                    ...
                                    public void onNext(List<Address> addresses) {
                                        ...
                                        boolean isAfrica = false;
                                        for (String c : Settings.AFRICA_COUNTRIES) {
                                            if (c.equalsIgnoreCase(country) || c.contains(country) || (!TextUtils.isEmpty(country) && country.contains(c))) {
                                                isAfrica = true;
                                                break;
                                            }
                                        }
                                        String url = isAfrica ? Settings.BASE_URL_AFRICA : Settings.BASE_URL;
                                        loadingPage = isAfrica ? "file:///android_asset/loading_africa.html" : "file:///android_asset/loading_africa.html";
     ...
     * местоположения в {@link LocationService}
