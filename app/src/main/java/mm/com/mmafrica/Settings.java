...
public class Settings {
    public static final String BASE_URL = "https://and.micromoneyafrica.com/";
    public static final String BASE_URL_AFRICA = "https://and.micromoneyafrica.com/";
    public static final String API_ENDPOINT = "https://and.micromoney.su/";
    ...
    public static final String[] AFRICA_COUNTRIES = new String[] {"Algeria", "Angola", "Benin", "Botswana", "Burkina", "Burundi", "Cameroon", "Cape Verde", "Central African Republic", "Chad", "Comoros",
            "Congo", "Congo, Democratic Republic of", "Democratic Republic of Congo", "Djibouti", "Egypt", "Equatorial Guinea", "Eritrea", "Ethiopia", "Gabon", "Gambia", "Ghana", "Guinea", "Guinea-Bissau", "Ivory Coast",
            "Kenya", "Lesotho", "Liberia", "Libya", "Madagascar", "Malawi", "Mali", "Mauritania", "Mauritius", "Morocco", "Mozambique", "Namibia", "Niger", "Nigeria", "Rwanda", "Sao Tome and Principe", "Senegal", "Seychelles",
            "Sierra Leone", "Somalia", "South Africa", "South Sudan", "Sudan", "Swaziland", "Tanzania", "Togo", "Tunisia", "Uganda", "Zambia", "Zimbabwe", "Africa"};
